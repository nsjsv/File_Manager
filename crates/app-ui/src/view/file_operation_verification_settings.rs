...
use crate::config::file_operation_verification_label;
use crate::model::Message;
use crate::typography::readable_text;

const FILE_OPERATION_VERIFICATION_OPTIONS: [FileOperationVerification; 3] = [
    FileOperationVerification::Off,
...
fn file_operation_verification_button(
    ...
    let label = container(readable_text(file_operation_verification_label(verification)).size(12))
        .padding([5, 8])
        .width(Length::Fill);

...
impl IconSymbol {
    ...
    pub(crate) fn bytes(self) -> &'static [u8] {
        match self {
            ...
            Self::Hash => include_bytes!("../assets/icons/lucide/hash.svg"),
